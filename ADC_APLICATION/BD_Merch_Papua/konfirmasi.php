...
<html>
<head>
<title>B&D MERCH PAPUA - Konfirmasi Pembayaran</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="product_list_header">  
					<a href="cart.php"><button class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button>
					 ...
					 <a href="logout.php"><button class="close_1.png" type="submit" name="submit" value=""><i class="close_1.png" aria-hidden="true"></i></button>
					 </a>
			</div>
