...
$timenow = date("j-F-Y-h:i:s A");
	...
	$queryuser = mysqli_query($conn,"SELECT * FROM tb_seller WHERE email='$email'");
	$cariuser = mysqli_fetch_assoc($queryuser);
		
		if( password_verify($pass, $cariuser['pass']) ) {
...
<html>
<head>
<title>B&D MERCH PAPUA - Login</title>
<!-- for-mobile-apps -->
	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>B&D MERCH PAPUA <a href="products.php">BELANJA SEKARANG!</a></p>
			</div>
			<div class="agile-login">
				<ul>
					<li><a href="registered.php"> Daftar</a></li>
					<li><a href="login.php">Login Seller</a></li>
