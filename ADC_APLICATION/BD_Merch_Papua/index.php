	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>B&D MARCH PAPUA, <a href="product.php">Belanja Sekarang</a></h1></p>
			</div>
			<div class="agile-login">
				...
				if(!isset($_SESSION['log'])){
					echo '
					<li><a href="registered.php"> Regist </a></li>
					<li> <a>|</a> </li>
					...
					<li><a href="penjual">Seller Panel</a></li>
	...
	<div class="logo_products">
		...
		<div class="w3ls_logo_products_left1">
			...
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php">B&D MARCH PAPUA</a></h1>
			</div>
...
<!-- //navigation -->
	<!-- main-slider -->
		<ul id="demo1">
			...
			<li>
				<img src="images/welcome1.jpg" alt="" />
			</li>
		</ul>
	<!-- //main-slider -->
...
<div class="footer">
		<div class="container">
		<div class="cold-md6 d-flex">
			<div style="width: 100%">
				<iframe width="1200" height="300" 
					src="https://maps.google.com/maps?width=100%&amp;height=600&amp;hl=en&amp;coord=-3.7576348,102.2873882&amp;q=Kost%20Indah%20Jaya%20Belakang%20No.%2019%2C%20Jl.%20Medan%20Baru%20VI%2C%20Kandang%20Limun%2C%20Bengkulu+(Toko%20Sayur%2022)&amp;ie=UTF8&amp;t=&amp;z=15&amp;iwloc=B&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0">
