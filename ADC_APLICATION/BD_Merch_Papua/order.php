...
<html>
<head>
<title>B&D MERCH PAPUA - Keranjang Saya</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="product_list_header">  
					<a href="cart.php"><button class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button>
					 ...
					 <a href="cart.php"><button class="images-close_1.png" type="submit" name="submit" value=""><i class="images-close_1.png" aria-hidden="true"></i></button>
					 </a>
			</div>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Asian Development Company</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@email">ADCapplication@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+62 813 5411 2174</li>
					</ul>
				</div>
				<div class="col-md-3 w3_footer_grid">
					<h3>Tentang Kami</h3>
					<ul class="info"> 
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="about.html">Alfiyah Faridah</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="about.html">Bakti Prasetyo</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="about.html">Devi Maharani</a></li>
						<li><i class="fa fa-arrow-right" aria-hidden="true"></i><a href="about.html">Sri Wulandari</a></li>
					</ul>
				</div>
				<div class="clearfix"> </div>
			</div>
