...
<html>
<head>
<title>B&D MERCH - Checkout</title>
<!-- for-mobile-apps -->
	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>OLEH - OLEH HASIL KERAJINAN MASYARAKAT PAPUA, BELANJA SEKARANG!</p>
			</div>
...
<!-- checkout -->
	<div class="checkout">
		<div class="container">
			<h1>Terima kasih, <?=$_SESSION['name']?> telah membeli <?php echo $itungtrans3 ?> barang di B&D MERCH</span></h1>
...
<div class="footer">
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Jl. Malaingkedi Km.8 - Sorong <span>Papua Barat.</span></li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">bd_merch_papua@gmail.com</a></li>
		...
		<div class="footer-copy">
			...
			<div class="container">
			<p>© 2023 Papua. All rights reserved | Design by <a href="http:/Merch Papua.com/">B&D MERCH PAPUA</a></p>
			</div>
		</div>
