...
<html>
<head>
<title>B&D MERCH PAPUA - Daftar Belanja</title>
<!-- for-mobile-apps -->
	...
	<div class="agileits_header">
		<div class="container">
			<div class="w3l_offers">
				<p>B&D MERCH PAPUA, <a href="product.php">Belanja Sekarang</a></p>
			</div>
			...
			<div class="product_list_header">  
					<a href="cart.php"><button class="w3view-cart" type="submit" name="submit" value=""><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></button>
					 ...
					 <a href="logout.php"><button class="images-close_1.png" type="submit" name="submit" value=""><i class="images-close_1.png" aria-hidden="true"></i></button>
					 </a>
			</div>
