		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
		  if($ukuran_file <= 5000000){ 
			if(move_uploaded_file($tmp_file, $path)){ 
			  ...
			  $query = "INSERT INTO produk (idproduk,idkategori, namaproduk, gambar, deskripsi, rate, hargabefore, hargaafter)
			  values('$id','$idkategori','$namaproduk','$pathdb','$deskripsi','$rate','$hargabefore','$hargaafter')";
...
<head>
    ...
    <title>Kelola Produk - B&D MERCH PAPUA</title>
    ...
    <div class="page-container">
        ...
        <footer>
            <div class="footer-area">
                <p>(ADC) Asian Development Company</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="form-group">
									...
									<input name="idproduk" type="text" class="form-control" required autofocus>
								</div>		
						<div class="form-group">
