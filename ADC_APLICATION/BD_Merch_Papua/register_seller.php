...
if(isset($_POST['adduser']))
	{
		...
		$tambahuser = mysqli_query($conn,"insert into tb_seller (id,nama, email, pass, no_hp, alamat) 
		values(null,'$nama','$email','$pass','$telp','$alamat')");
		if ($tambahuser){
...
<html>
<head>
<link href="css/sb-admin-2" rel="stylesheet">
<link href="css/sb-admin-2.min" rel="stylesheet">
<title>B&D MERCH PAPUA - Daftar</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="agile-login">
				<ul>
					...
					<li><a href="registered.php">Regist Customer</a></li>
					<li> <a>|</a> </li>
					<li><a href="">Regist Seller</a></li>
